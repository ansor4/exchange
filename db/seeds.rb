...
# "test" of "Folio Test Partner". It is available on production so it will be copied over to staging each week.
LineItem.create(artwork_id: '54c0310772616961ff030700', artwork_version_id: '60c27e0cf448330013d340a5', order: order)
