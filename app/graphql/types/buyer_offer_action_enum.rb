class Types::BuyerOfferActionEnum < Types::BaseEnum
  ...
  value 'RECEIVED_OFFER_CONFIRM_NEEDED', 'Buyer received a counter offer needs to confrim tax and shipping', value: 'RECEIVED_OFFER_CONFIRM_NEEDED'
  ...
  value 'RECEIVED_OFFER', 'Buyer recieved a counter offer', value: 'RECEIVED_OFFER'
